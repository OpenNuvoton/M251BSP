 ...
 * @file     TK_Main.c
 * @version  V1.00
 * @brief    Demonstrate how to calibrate TK1 in the NuMaker-M256SD board.
 *           After the calibration completes, LCD displays M256SD temperature,
 *           firmware version, and TK1 press information.
 *
...
int32_t main(void)
{
    ...
    do
    {
        ...
        if (i8KeyVal != i8KeyValPre)
        {
            ...
            if ((i8KeyVal == 1) && (i8KeyValPre == (int8_t)0xff))
            {
            ...
            else if ((i8KeyVal == (int8_t)0xFF) && (i8KeyValPre == (int8_t)1))
            {
